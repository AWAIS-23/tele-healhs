            ...
            <div className="min-w-0">
              ...
              <div className="prose prose-lg max-w-none">
                  ...
                  <table className="min-w-full border border-gray-200">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="px-4 py-3 text-sm text-gray-700 border-b">Health Shield</td>
                      ...
                      <tr>
                        ...
                        <td className="px-4 py-3 text-sm text-gray-700">Health Shield</td>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Health Shield currently integrates Ethizo with four leading facility EHR platforms:
                </p>
              </div>
            </div>

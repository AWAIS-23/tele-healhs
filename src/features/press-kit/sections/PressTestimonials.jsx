...
const testimonials = [
  {
    ...
    type: "Client Review",
    quote: "Health Shield has transformed how we manage chronic care. The automation alone has saved our team countless hours, allowing us to focus on patient outcomes.",
  ...
  },
  {
    ...
    quote: "The engineering-first approach is evident in every feature. Health Shield doesn't just add features — they solve real problems healthcare providers face daily.",
  ...
  },
  {
    ...
    quote: "Health Shield represents the future of care management. Their platform demonstrates how technology can truly enhance, not replace, the human element in healthcare.",

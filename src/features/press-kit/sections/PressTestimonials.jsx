...
const testimonials = [
  {
    ...
    type: "Client Review",
    quote: "tele Health has transformed how we manage chronic care. The automation alone has saved our team countless hours, allowing us to focus on patient outcomes.",
  ...
  },
  {
    ...
    quote: "The engineering-first approach is evident in every feature. tele Health doesn't just add features — they solve real problems healthcare providers face daily.",
  ...
  },
  {
    ...
    quote: "tele Health represents the future of care management. Their platform demonstrates how technology can truly enhance, not replace, the human element in healthcare.",

...
const faqs = [
  {
    question: "How can I request an interview with Health Shield leadership?",
  ...
  {
    question: "What Medicare programs does Health Shield support?",
    answer: "Health Shield powers five Medicare programs: Remote Patient Monitoring (RPM), Chronic Care Management (CCM), Principal Care Management (PCM), Behavioral Health Integration (BHI), and Remote Therapeutic Monitoring (RTM). Our platform supports all 50 states.",
  },
  {
  ...
  {
    question: "Can I use Health Shield logos and brand assets?",
  ...
  {
    question: "How can healthcare providers partner with Health Shield?",
    answer: "Healthcare providers interested in partnering with Health Shield can schedule a consultation through our website or contact our partnerships team at partners@ccnhealth.com. We offer demos, pilot programs, and customized implementation plans.",
  },
  {
    question: "What is Health Shield's stance on data privacy and security?",
    answer: "Health Shield is HIPAA compliant and SOC 2 Type II certified. We maintain the highest standards of data security and privacy. All patient data is encrypted, and we follow strict protocols to protect healthcare information.",
  },
];

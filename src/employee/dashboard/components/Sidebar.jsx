...
export default function EmployeeSidebar() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      dropdownItems: [
        { label: "Landing Page Leads", href: "/employee/leads?tab=landing_page", permission: "read_leads_landing_page" },
        { label: "Contact Us Leads", href: "/employee/leads?tab=contact_us", permission: "read_leads_contact_us" },
        { label: "Funnel Leads", href: "/employee/leads?tab=funnel", permission: "read_leads_funnel" },
      ]
    },
    {
      label: "Settings",
            ...
            <div className="flex items-center gap-3">
              ...
              {!isCollapsed && (
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-900 truncate">Employee User</p>
                  <p className="text-xs text-gray-500 truncate">employee@ccnhealth.com</p>
                </div>
              )}
            </div>
            <button

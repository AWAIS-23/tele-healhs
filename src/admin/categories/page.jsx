...
export default function CategoriesListPage() {
  ...
  const fetchCategories = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/blog-categories?${params}`);
      ...
      <div className="lg:ml-64">
        <main className="p-8">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            {permissions.includes('create_categories') && (
              <Link
                        ...
                        <tr key={category.id} className="hover:bg-gray-50">
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-3">
                              {category.image && (
                                <img
                                  src={`${UPLOADS_URL}/uploads/${category.image}`}
                                  alt={category.name}
                          ...
                          <td className="px-6 py-4 text-right">
                            <div className="flex items-center justify-end gap-2">
                              ...
                              {permissions.includes('update_categories') && (
                                <Link
                              ...
                              {permissions.includes('delete_categories') && (
                                <button
